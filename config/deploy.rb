...
set :scm, :git
set :repository,  "git@github.com:rotrer/capistrano2.git"
# set :scm, :subversion
...
set :local_path, "/Users/CAlvarado/Sites/labs/capistrano2"
